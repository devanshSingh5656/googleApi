  ...
  return (
    <div className="flex flex-col h-screen items-center justify-center">
      ...
      <form className=" flex flex-col items-center mt-44  flex-grow  w-4/5">
        ...
        <div className="flex flex-col w-6/12 space-y-2 justify-center mt-8 sm:flex-row sm:space-y-0 sm:space-x-4">
          <button
            onClick={Search}
            className="text-sm bg-gray-100 text-gray-800  py-1 px-4 focus:outline-none hover:border border-gray-400 hover:shadow-lg"
          >
            Google Search
          </button>
          <button
